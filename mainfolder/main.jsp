...
<a href="main.jsp">
<img src="/pt1/mainfolder/image/main_image.png" width="80" height="30"/></a>
<a href="shop.jsp">
<img src="/pt1/mainfolder/image/shop_image.png" width="80" height="30"/></a>
<a href="item.jsp">
<img src="/pt1/mainfolder/image/item_image.png" width="80" height="30"/></a>
<a href="sale.jsp">
<img src="/pt1/mainfolder/image/sale_image.png" width="80" height="30"/></a>
<a href="more.jsp">
<img src="/pt1/mainfolder/image/more_image.png" width="80" height="30"/></a>
<%-- 로그인 페이지로 이동 (수정) --%>
 <table>
		...
		<tr>
			<td>
				...
				<input type="button" value="베스트상품 페이지로 이동" 
					onclick="location='/pt1/mainfolder/best.jsp'" /><br />
			</td>
		</tr>
		<tr>
			<td>
				...
				<img src="/pt1/mainfolder/image/goods_image.png" width="80" height="30"/></a>
			</td>
			<td>
				<%-- brand_image.png 사진 클릭하면 Type=B 파라미터 추가 --%>
				<a href="main.jsp?Type=B">
				<img src="/pt1/mainfolder/image/brand_image.png" width="80" height="30"/></a>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				...
				<input type="button" value="카테고리" 
					onclick="location='/pt1/mainfolder/search.jsp'" />
			</td>
		</tr>
		<tr>
			<td>
